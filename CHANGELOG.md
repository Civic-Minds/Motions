...
- **Social Preview Overhaul** — added a premium "Technical Precision" social preview graphic and generalized description text to remove city-specific constraints for future expansion.
