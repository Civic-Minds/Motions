...
- **Election page**: Put each incumbent’s record directly above its corresponding candidate list, aligned the page with Motions, and removed redundant section copy.
