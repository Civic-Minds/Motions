...
- **Back button overlapping the page title**: On meeting, motion, and committee pages, the floating back arrow could land on top of the heading instead of beside it — the button and the page column both changed width at the same screen size, leaving it no room to float into.
