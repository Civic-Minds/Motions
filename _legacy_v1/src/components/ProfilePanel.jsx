            ...
            <div className="profile-header flex justify-between items-start">
                <div>
                    ...
                    <p className="text-xs text-slate-400 font-bold mt-1">
                        {COUNCILLOR_WARD[selected]
                            ? `Ward ${COUNCILLOR_WARD[selected].id} · ${COUNCILLOR_WARD[selected].name}`
                    ...
                    {attendance && (
                        <div className="flex gap-3 mt-3">
                            <div className="text-center">
                                ...
                                <div className="text-xs text-slate-400 font-bold">votes cast</div>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-xs text-slate-400 font-bold">meeting days</div>
                            </div>
                            <div className="text-center">
                                <div className={`text-lg font-black ${attendance.pct >= 90 ? 'text-emerald-600' : attendance.pct >= 75 ? 'text-amber-500' : 'text-rose-500'}`}>
                                    {attendance.pct}%
                                </div>
                                <div className="text-xs text-slate-400 font-bold">attendance</div>
                            </div>
                        </div>
                    )}
                </div>
                <div className="flex gap-2">
                    <button
                        ...
                        className="px-3 py-1.5 bg-[#004a99] text-white text-xs font-bold rounded-lg hover:bg-blue-800 transition-colors"
                    >
                        Versus Mode
                    </button>
