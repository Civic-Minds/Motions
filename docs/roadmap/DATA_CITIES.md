...
- [ ] **Yellowknife** — Official council agendas and minutes are available through the City's [Council Calendar](https://events.yellowknife.ca/meetings). The importer covers the current council term through bounded calendar date windows and only records individual votes when the minutes explicitly provide them; improve roll-call coverage before promoting the jurisdiction broadly. Yellowknife's next municipal election is October 19, 2026.
