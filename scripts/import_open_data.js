...
const WARD_KEYWORDS = {
    ...
    '6':  ['York Centre', 'Bathurst Manor', 'Lawrence Heights', 'Clanton Park'],
    '7':  ['Humber River', 'Black Creek', 'Jane and Finch', 'Downsview', 'Glenfield'],
    ...
    '17': ['Don Valley North', 'Seneca Heights', 'Bayview Village', 'Victoria Village'],
    '18': ['Willowdale', 'North York Centre'],
    '19': ['Beaches-East York', 'The Beach'],
    '20': ['Scarborough Southwest', 'West Hill', 'Centennial', 'Port Union'],
    '21': ['Scarborough Centre', 'Kennedy Park', 'Wexford', 'Ionview'],
    '22': ['Scarborough-Agincourt', 'Tam O\'Shanter', 'Sullivan'],
    '23': ['Scarborough North', 'Milliken', 'Steeles-L\'Amoreaux'],
    '24': ['Scarborough-Guildwood', 'Guildwood', 'Morningside'],
