...
const GUIDE_CONTENT = {
  ...
  strongMayor: {
    ...
    steps: [
      ...
      ['4', 'The Mayor proposes the budget', 'The Mayor presents a proposed City budget. Council can amend it within the review period. The Mayor may veto Council amendments, and Council can override that veto with a two-thirds vote under the statutory process.'],
      ['5', 'Some powers relate to provincial priorities', 'The Mayor can bring matters to Council that advance prescribed provincial priorities, including housing and infrastructure, and may veto some by-laws if they could interfere with those priorities.'],
      ['6', 'The paper trail is public', 'Strong Mayor powers must be exercised in writing and made available to the public. The City’s Mayoral Decisions register is the place to follow those decisions, notices, and related documents.'],
    ],
    resources: {
      Toronto: [
        ['Toronto Mayoral Decisions', 'https://www.toronto.ca/city-government/council/council-committee-meetings/mayoral-decisions/'],
