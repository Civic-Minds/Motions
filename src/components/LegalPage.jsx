...
const CONTENT = {
  privacy: {
    ...
    sections: [
      ...
      ['When you contact us', 'The contact form opens your email app and does not store your message on Motions. Your message and email address are handled by your email provider and Civic Minds’ email service.'],
