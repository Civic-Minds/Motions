...
const CONTENT = {
  privacy: {
    ...
    sections: [
      ...
      ['Local storage and location access', 'Motions may store your selected Toronto ward or followed committees in your browser so the site can remember your preferences. These values are not submitted to Motions. Toronto’s Find My Ward feature requests your device location only after you choose that feature; the location is used in your browser to identify a ward and is not stored by Motions.'],
      ...
      ['Access, correction, and complaints', 'If you believe Civic Minds holds personal information about you, or if you have a privacy complaint, contact Civic Minds through the project’s public contact channel. Do not include sensitive personal information in a public GitHub issue. A dedicated privacy email will be listed here when available.'],
      ['External services and changes', 'When you open an official source, map, GitHub issue form, or other external link, that service’s own privacy policy applies. This policy may be updated when the site or its services change.'],
    ],
  },
  terms: {
    title: 'Terms | Motions',
