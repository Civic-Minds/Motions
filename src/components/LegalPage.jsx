...
const CONTENT = {
  privacy: {
    ...
    sections: [
      ...
      ['Access, correction, and complaints', 'If you believe Civic Minds holds personal information about you, or if you have a privacy complaint, contact Civic Minds using the privacy contact published with this policy. Do not include sensitive personal information in a public GitHub issue. A dedicated privacy email will be added before this policy is treated as final.'],
