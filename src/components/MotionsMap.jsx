    ...
    <div className="space-y-4 pb-20">
      ...
      <PageColumn>
        ...
        <p className="mt-3 max-w-2xl text-slate-500">
          {hasWards
            ? <>Motions plotted at their exact address. To browse by ward instead, see the <a href="/wards" className="font-semibold text-[#004a99] hover:underline">wards page</a>. </>
