      ...
      {selected && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-16 right-0 bottom-0 w-full sm:w-[420px] bg-white border-l border-slate-200 shadow-2xl z-50 flex flex-col overflow-hidden"
          >
            {/* Header */}
              ...
              <div>
                ...
                <div className="space-y-2">
                  {filteredVoteHistory.map((m, i) => {
                    ...
                    return (
                      <div key={i} className="p-3.5 border border-slate-100 rounded-xl hover:border-[#004a99]/30 transition-all bg-white group">
