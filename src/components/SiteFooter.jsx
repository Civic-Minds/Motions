...
export default function SiteFooter() {
  return (
    <footer className="mt-8 border-t border-slate-200 bg-white">
      <div className="mx-auto grid max-w-[1400px] gap-8 px-6 py-8 sm:grid-cols-[1.4fr_repeat(3,1fr)] sm:gap-6 sm:py-10">
        <div className="space-y-2">
          ...
          <p className="max-w-xs text-sm leading-relaxed text-slate-500">
            A clearer way to follow Toronto council decisions and votes.
          </p>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Link to="/wards" className={linkClass}>Wards</Link>
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="https://open.toronto.ca/" target="_blank" rel="noopener noreferrer" className={linkClass}>Toronto Open Data</a>
          </div>
        </div>
      ...
      <div className="border-t border-slate-100">
        <div className="mx-auto flex max-w-[1400px] flex-col gap-2 px-6 py-4 text-xs text-slate-400 sm:flex-row sm:items-center sm:justify-between">
          <span>Independent civic information for Toronto.</span>
